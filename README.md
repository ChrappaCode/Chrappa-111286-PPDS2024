...
Zadanie spočíva k úprave kódu z cvičenia, inšpirovaného z [kódu](https://kurzy.kpi.fei.tuke.sk/pp/labs/pp_mm.c). Našou úlohou je úprava P2P komunikácie aby fungovala a umoňila vykonanie pre ľubovoľný počet pracovných uzlov tj. že počet riadkov matice nebude musieť byť deliteľný počtom pracovných uzlov. Druhou častou zadania je pretvorenie kódu z P2P komunikácie na **kolektívnu komunikáciu** pomocou `scatter()/gather()`
